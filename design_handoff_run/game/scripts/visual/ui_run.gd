...
const CHIP_EDGE := Color("#CBC2B6")       # = RIM_EDGE iz UiArena
...
const COIN_EDGE := Color("#D6A82F")       # = GOLD_EDGE iz UiArena
const COIN_INNER := Color("#FFE8B8")
const COIN_GLINT := Color("#FFF3D0")

const SEED_SIZE := 120                    # bio 52 (≈ 19 dp) — necitljivo
const SEED_WELL := Color("#22342A")       # isto kao UiArena.SEED_WELL
...
const STUMP := Color("#9E7A52")            # = UiArena.BAG_BODY
const STUMP_EDGE := Color("#735738")
const STUMP_CAP := Color("#B89466")
